function [H, f, Ac, Ax, b, lb, ub, options] = MPC_varsFIR(A, B, C, K_opt, R, p, bnds, maxF, Fcoefs)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
F_big = ConvFIRmat(Fcoefs, p);  % p+1-length(Fcoefs(1, :))
As = F_big*As;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bounds2 = bnds;
for i = 1: length(As(:,1))/length(bnds) -1
